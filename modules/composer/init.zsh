# ------------------------------------------------------------------------------
#          FILE:  composer.zsh
#   DESCRIPTION:  prezto composer plugin file.
#        AUTHOR:  Daniel Gomes (me@danielcsgomes.com)
#                  Quentin Burgess (qutn.burges@gmail.com)
#       VERSION:  1.0.1
# ------------------------------------------------------------------------------

# This is a curl + edit from https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/plugins/composer/composer.plugin.zsh
